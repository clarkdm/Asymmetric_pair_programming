...
class Read_write_Request implements Runnable, Observer {
	...
	private void processRequest() throws Exception {
		...
		if (method.equals("POST")) {
			...
			System.out.println("15_15_15_15 " + command);

			if (command_type.contains("keypress")) {
				System.out.println("keypress");
				String file_Name = tokens_2.nextToken();
				keypress(command, file_Name, os, br);
	...
	private void keypress(String command, String file_Name, DataOutputStream os, BufferedReader br) throws IOException {
		String statusLine = "";
		String contentTypeLine = "";
		String entityBody = "";
		String ContentLength = "";

		if (files.new_character(file_Name, command)) {
